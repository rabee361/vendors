...
basePatterns = [
    ...
    path('ads/<int:ad_id>/visit/', base.SponsoredAdClickRedirectView.as_view(), name='sponsored_ad_click'),
...
moderatorPatterns = [
    ...
    path('ads/', moderators.ModeratorAdsView.as_view(), name='moderator_ads'),
    path('ads/update/<int:pk>/', moderators.ModeratorAdUpdateView.as_view(), name='moderator_ad_update'),
    ...
    path('settings/', moderators.ModeratorSettingsView.as_view(), name='moderator_settings'),
    path('settings/update/<int:pk>/', moderators.ModeratorSettingUpdateView.as_view(), name='moderator_setting_update'),
]
